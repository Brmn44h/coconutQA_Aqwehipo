...
from Cinemascope.constants import RED, GREEN, RESET
...
class CustomRequester:
	...
	def __init__(self, session, base_url, base_headers=None):
		self.base_url = base_url
		self.session = requests.Session()
		self.session.headers = base_headers.copy() if base_headers else {}
